...
public:
	...
	// mută cursorul iteratorului a.î. să refere a k-a pereche începând de la cea curentă. Iteratorul devine nevalid în cazul în 
	// care există mai puțin de k perechi rămase în multidicționar. 
